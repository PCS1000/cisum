...
class _PlayerWhiteState extends State<PlayerWhite> {
  ...
  Widget build(BuildContext context) {
    ...
    var durationText = duration != null ? duration.toString().split('.').first.replaceRange(0, 2, '') : '';
    var positionText = position != null ? position.toString().split('.').first.replaceRange(0, 2, '') : '';
        ...
        children: <Widget>[
          ...
          Align(
              ...
              child: GestureDetector(
                onTap: () async {
                  if(this.url != '') await FirebaseStorage.instance.getReferenceFromUrl(this.url).then((image) => image.delete());
                  File imgFile = await ImagePicker.pickImage(source: ImageSource.gallery);
                  StorageUploadTask task = FirebaseStorage.instance.ref().child(imgFile.toString()).putFile(imgFile);
          ...
          Padding(
            ...
            child: Align(
              ...
              child: GestureDetector(
                onTap: (){
                  widget.controller.previousPage(duration: Duration(milliseconds: 700), curve: Curves.ease);
                },
                child: _buttonPlayer(
                  height: 60,
                  width: 60,
                  ...
                  child: AlertDialog(
                    ...
                    content: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          textField(_titleController, _titleFocus, _nameFocus, Icons.music_note),
                          textField(_nameController, _nameFocus, new FocusNode(), Icons.photo),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget textField(TextEditingController controller,FocusNode focus,FocusNode nextFocus,IconData icon){
    return Container(
  ...
  Widget _buttonPlayer({double height,double width,double height2,double width2,IconData icon,bool isBigButton,Widget child,DecorationImage image,bool isSquare}){
    return Container(
      height: height,
      width: width,
      alignment: Alignment.center,
      margin: EdgeInsets.only(top: isSquare == true ? 70 : 25,left: 15,right: 15),
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            color: Color(0xFFFFFFFF).withOpacity(isBigButton == true ? 0.60 : 0.80),
          ),
          BoxShadow(
            spreadRadius: 0,
      ...
      child: Container(
        ...
        child: icon != null ? Icon(icon,color: Colors.black54,) : child ?? Container(),
      ),
    );
  }
}
